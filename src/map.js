...
info.update = function (props) {
    this._div.innerHTML = (props ?
        ...
        '<b>Vivienda asequible, de calidad y con servicios '  + props.VIV_1.toFixed(0)  + ' %' + '</b>'+ '<br />' +
...
var legends = {
    INDICE_MAR: {
        ...
        subtitle: "%", 
        elem1: '<div><span  style= "color:#FCF9BB">▉</span>71 - 79</div>',
        elem2: '<div><span  style= "color:#FE9D6C">▉</span>61 - 70</div>', 
        elem3: '<div><span  style= "color:#CA3E72">▉</span>51 - 60</div>',
        elem4: '<div><span  style= "color:#862781">▉</span>41 - 50</div>',
        elem5: '<div><span  style= "color:#2A115C">▉</span>39 - 40</div>',
        elem6: '',
        elem7: '',
